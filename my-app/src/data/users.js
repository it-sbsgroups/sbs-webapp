...
export const USERSETTINGS = [ // can only one data we can edit and update only can not delete and create
    {
        ...
        companyHeaderLogoURL: "https://sbsgroups.co.in/assets/sbs_logo.png", // company header logo can be 
        CompanyFooterLogo: "https://sbsgroups.co.in/assets/sbs_logo.png", // compnay footer logo can be same or different
        companyFavIcon: "https://sbsgroups.co.in/assets/sbs_logo.png", // place favicon to show
        CompanyOgTiltle: "SBS Groups we protect your people and project", // write og title
        CompanyOgImage: "https://sbsgroups.co.in/assets/sbs_logo.png", // upload og image

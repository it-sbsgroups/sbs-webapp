...
export default function PublicAboutPage() {
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-white py-24">
      {/* Left Dot Pattern */}
      <svg
        className="absolute left-6 top-16 w-20 opacity-70 hidden lg:block"
        viewBox="0 0 120 120"
        fill="none"
      >
        {[...Array(10)].map((_, row) =>
      ...
      {/* Right Triangle */}
      <svg
        className="absolute right-10 top-12 w-36 opacity-90 hidden lg:block"
        viewBox="0 0 200 180"
        fill="none"
      >
        <polygon
          points="100,10 190,160 20,130"
          stroke="#ef4444"
          strokeWidth="4"
        />
      </svg>
      ...
      {/* Left Circle */}
      <svg
        className="absolute left-6 top-72 w-10 opacity-30 hidden lg:block"
        viewBox="0 0 100 100"
      >
        <circle
          cx="50"
      ...
      <svg
        className="absolute left-0 bottom-36 w-16 opacity-20 hidden lg:block"
        viewBox="0 0 100 100"
      >
        <polygon
          points="10,90 60,10 90,95"
          stroke="#ef4444"
          strokeWidth="3"
          fill="none"
        />
      ...
      <svg
        className="absolute right-8 bottom-28 w-32 opacity-20 hidden lg:block"
        viewBox="0 0 200 180"
      >
        <polygon
          points="100,10 190,160 20,130"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="mt-6 text-4xl md:text-5xl font-black uppercase text-gray-900 leading-tight">
              About Us
            </h2>
            ...
            <p className="mt-8 text-gray-600 leading-8">
              {loading ? (
                ...
                <div className="max-w-3xl mx-auto text-center space-y-4">
                  ...
                  <div className="prose prose-slate prose-sm md:prose-base mx-auto text-left prose-headings:font-black prose-headings:text-slate-900 prose-a:text-blue-700" 
            ...
            <div className="mt-12 flex items-center gap-6">
              ...
              <p className="text-gray-600 leading-7">
                Proudly serving industries with innovative safety products,
                reliable support, and uncompromising quality standards.
              </p>
          ...
          <div className="relative">
            ...
            {/* Dot Pattern */}
            <svg
              className="absolute -left-10 bottom-12 w-20 opacity-70"
              viewBox="0 0 120 120"
            >
              {[...Array(7)].map((_, row) =>
                [...Array(6)].map((_, col) => (
      ...
      {/* <div className="relative bg-slate-950 text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 md:py-28 text-center space-y-5 relative">
          ...
          <p className="text-sm md:text-base text-slate-400 font-medium max-w-xl mx-auto">
            Every product we supply, every partnership we build, is held to one standard — 
            reliability our clients can plan their operations around.
          </p>
        </div>
      </div> */}
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 md:py-20 space-y-20">
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-2xl font-black text-slate-900 mt-1">
                Quality Isn&rsquo;t Inspected In — It&rsquo;s Built In
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {coreValues.map((cv, i) => (
                <div key={i} className="bg-white border border-slate-200 rounded-2xl p-6 space-y-2 hover:border-blue-300 hover:shadow-lg transition-all">
                  <span className="text-xs font-black text-blue-900 bg-blue-50 border border-blue-100 px-2 py-0.5 rounded-md">
                    0{i + 1}
                  </span>
                  ...
                  <div key={i} className={`flex flex-col md:flex-row items-center gap-6 ${i % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
                    <div className="flex-1">
                      <img 
                        ...
                        src={img.url} 
                        alt={img.caption || ""} 
                        className="w-full rounded-2xl border border-slate-200 shadow-sm object-cover max-h-80"
                      />
                    </div>
                    <div className="flex-1 text-center md:text-left px-4">
                      {img.year && (
                        <span className="inline-block text-xs font-black text-blue-900 bg-blue-50 px-3 py-1 rounded-full mb-2">
                          {img.year}
                        </span>
                      )}
                      {img.caption && (
              ...
              <div key={i} className="bg-slate-900 text-white p-8 rounded-3xl space-y-4">
                ...
                <div className="space-y-3">
                  {(vm.points || []).map((pt, pi) => (
                    <div key={pi}>
                      {pt.heading && (
                        <p className="text-xs font-black text-lime-400 uppercase mb-0.5">
                          {pt.heading}
                        </p>
                      )}
        ...
        <div className="bg-gradient-to-r from-blue-950 to-blue-900 rounded-3xl p-8 md:p-12 text-center text-white space-y-4">
          ...
          <p className="text-blue-200 max-w-xl mx-auto">
            Get in touch with our team to discuss your industrial supply needs.
          </p>
          <Link href="/contact">
            <button className="bg-lime-400 text-slate-950 font-black text-xs px-8 py-4 rounded-xl uppercase tracking-wider hover:bg-lime-300 transition-colors">
              Contact Us Today →
            </button>
          </Link>
        </div>

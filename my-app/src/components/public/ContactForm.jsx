...
/**
 * Reusable contact enquiry form. Handles its own state, validation, and submission.
 *
 * Props:
 * - successMessage: string shown in the success toast after a successful submit.
 * - onSuccess: optional callback invoked after a successful submit.
 * - title: heading shown above the form fields.
 */
export default function ContactForm({
  successMessage = "Thank you! Your enquiry has been captured seamlessly into SBS central node pipeline.",
  onSuccess,
  title = "Send Enquiry",
}) {
